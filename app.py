...
def configure():
    if request.method == 'POST':
        ...
        threading.Thread(target=os.system, args=(f"ansible-playbook -i inventory.ini /home/student/turn-key-roll-out-playbooks/setupK8SVM.yml --extra-vars 'network={network} vm_disk_gb={disk_space} vm_hw_cpu_n={num_cores} vm_hw_ram_mb={ram} vcenter_username={username} vcenter_password={password}'",)).start()
